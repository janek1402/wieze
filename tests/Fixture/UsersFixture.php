...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => 'user', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-07-16 16:27:51',
                'modified' => '2021-07-16 16:27:51',
            ],
        ];
        parent::init();
    }
