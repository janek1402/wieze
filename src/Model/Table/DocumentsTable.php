 ...
 * Documents Model
 *
 * @property \App\Model\Table\TowersTable&\Cake\ORM\Association\BelongsTo $Towers
 *
...
class DocumentsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['tower_id'], 'Towers'), ['errorField' => 'tower_id']);
